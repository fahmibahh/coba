        ...
        for index in self.buy_protection_params:
            ...
            if self.buy_params[f"buy_condition_{index}_enable"]:
                ...
                if index == 1:
                    ...
                    # Logic
                    item_buy_logic.append(((dataframe['close'] - dataframe['open'].rolling(12).min()) / dataframe['open'].rolling(12).min()) > self.buy_min_inc_1.value)
                    item_buy_logic.append(dataframe['rsi_14'] < self.buy_rsi_1.value)
                    item_buy_logic.append(dataframe['r_32'] < self.buy_r32_1.value)
                    ...
                    item_buy_logic.append(dataframe['r_480_1h'] > self.buy_r480_1h.value)
